...
export const AUTH = {
	...
	FORGOT_PASSWORD: asyncTypes("FORGOT_PASSWORD"),
	CHANGE_PASSWORD: asyncTypes("CHANGE_PASSWORD")
};
export const USER = {
...
export const OTHER = {
	...
	SHOW_TOAST: asyncTypes("SHOW_TOAST"),
	IS_TOAST_OPEN: asyncTypes("IS_TOAST_OPEN"),
	IS_TOAST_CLOSE: asyncTypes("IS_TOAST_CLOSE")
};
export const MEDIA = {
